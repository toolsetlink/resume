...
export function SelfEvaluationPanel() {
  ...
  const editor = useEditor({
    content,
    extensions: [StarterKit, Underline, TextStyle, Color, Highlight, Link.configure({ openOnClick: false }), TextAlign.configure({ types: ['heading', 'paragraph'] }), Placeholder.configure({ placeholder: '请输入自我评价...' })],
    onUpdate: ({ editor: ed }) => {
  ...
  return (
    <div className="p-4 space-y-3">
      <h3 className="text-base font-medium">自我评价</h3>
