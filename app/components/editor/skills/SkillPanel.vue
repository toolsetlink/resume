...
const content = ref(resumeStore.activeResume?.skillContent || '')

watch(() => resumeStore.activeResume?.skillContent, (val) => {
...
const commit = () => {
  ...
  resumeStore.updateSkillContent(resumeStore.activeResumeId, content.value)
}
